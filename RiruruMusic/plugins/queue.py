...
from config import BANNED_USERS, MUSIC_BOT_NAME, TELEGRAM_AUDIO_URL, TELEGRAM_VIDEO_URL, STREAM_IMG_URL, db
...
from RiruruMusic.utils import Altbin, get_channeplayCB
from RiruruMusic.utils.formatters import seconds_to_min
from RiruruMusic.utils.database import get_cmode, is_active_chat
