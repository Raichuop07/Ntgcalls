...
from RiruruMusic.utils.inline.settings import auth_users_markup, playmode_users_markup, setting_markup
...
async def settings_back_markup(client, CallbackQuery: CallbackQuery,_):
    if CallbackQuery.message.chat.type == ChatType.PRIVATE:
        ...
        await CallbackQuery.message.edit_caption(
            caption=_["start_2"].format(CallbackQuery.from_user.first_name, MUSIC_BOT_NAME),
            reply_markup=InlineKeyboardMarkup(buttons)
        )
    else:
        buttons = setting_markup(_)
