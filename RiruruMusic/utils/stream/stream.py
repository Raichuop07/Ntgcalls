...
from config import (
    PLAYLIST_FETCH_LIMIT, STREAM_IMG_URL, TELEGRAM_AUDIO_URL, TELEGRAM_VIDEO_URL, DURATION_LIMIT, db
)
...
from RiruruMusic.utils.database import is_active_chat, add_active_video_chat
