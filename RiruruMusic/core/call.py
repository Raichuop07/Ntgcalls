...
from pyrogram.errors import ChatAdminRequired, UserAlreadyParticipant, UserNotParticipant, InviteRequestSent
...
from RiruruMusic.utils.inline.play import stream_markup
        ...
        try:
            ...
            if get.status == ChatMemberStatus.BANNED:
                try:
                    ...
                    raise AssistantErr(_["call_2"].format(MUSIC_BOT_NAME, userbot.name, userbot.id, userbot.username))
        except ChatAdminRequired:
            ...
            try:
                ...
                try:
                    ...
                    raise AssistantErr(_["call_13"].format(userbot.name))
            except Exception as e:
